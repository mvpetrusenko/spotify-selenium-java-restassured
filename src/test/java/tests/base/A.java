   ...
   // public void setUp(){
    ...
    public static class BaseSetup {
        ...
        //public void setup() {
            ...
            String token = "BQAhDe7xiC5B_KP2jcai_OWT1BzYYJ3BFcfLbJJkXKP3AJJWJpi2TnrHJqI9hNZaXCKgN-kWQe48U_PQRd0L5ngmEdcv-zrprEXnbIJ0fkm2Jm9oOucrWwraj0JhNrafimET0QJWf9-GKx0C-I7-b_B1qPw_4b_8KdG3fmntd6MnkpLnfUgvjT8wBG_zrdHG2fiV";
...
//    }
    ...
    public class First extends BaseSetup {
        //Get artist

        @Test
        //public static void main(String[] args){
        public static void GetArtist(String token) {
